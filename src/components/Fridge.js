    ...
    return (
      <div>
        ...
        <nav className="menu toggleDisplay"  id="menu">
          ...
          <Link to="/ingredients" className="menu-item yellow"> </Link>
          <Link to="/World-food" className="menu-item orange"> </Link>
          <Link to="/recipe-of-the-day" className="menu-item red"> </Link>
        </nav>  
        </div>
